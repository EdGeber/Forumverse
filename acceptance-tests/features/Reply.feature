...
Scenario: Responder à lista de discussão
  ...
  Given eu estou na página da lista de discussão "Qual é a derivada de 2x" criada pelo usuário "Carlos"
  Given eu vejo a resposta do usuário João: "Não faço ideia"
  When eu envio a resposta "É 2" ao sistema
  Then eu continuo na página da discussão "Qual é a derivada de 2x" criada por "Carlos"
  Then eu vejo a resposta do usuário "João": "Não faço ideia"
  Then eu vejo logo abaixo da resposta de João a minha mensagem "É 2"
...
Scenario: Tentar responder lista com resposta em branco
  ...
  Then eu continuo na página da discussão "Qual é a derivada de 2x" criada por "Carlos"
  Then eu vejo a resposta do usuário "João": "Não faço ideia"
  Then eu vejo uma mensagem de erro indicando que não podem ser enviadas mensagens vazias

Scenario: Tentar responder à lista trancada
  Given eu estou logado como usuário 
  Given eu estou na página da lista de discussão "Qual é a derivada de 2x" criada pelo usuário "Carlos"
  Given eu vejo a resposta do usuário "João": "Não faço ideia"
  Given a lista de discussão está trancada
  When eu envio a resposta "É 2" ao sistema
  Then eu continuo na página da discussão "Qual é a derivada de 2x" criada por "Carlos"
  Then eu vejo a resposta do usuário "João": "Não faço ideia"
  Then eu vejo uma mensagem de erro indicando que a discussão está trancada e não aceita novas respostas
...
Scenario: Responder comentário da lista
  ...
  Then eu continuo na página da discussão "Qual é a derivada de 2x" criada por "Carlos"
  Then eu vejo a resposta do usuário "João": "Não faço ideia"
  Then eu vejo logo abaixo da resposta de João a minha resposta, composta por uma citação à mensagem de João e o conteúdo "É 2".
...
Scenario: Tentar responder lista sem estar logado
  ...
  Then eu continuo na página da discussão "Qual é a derivada de 2x" criada por "Carlos"
  Then eu vejo a resposta do usuário "João": "Não faço ideia"
  Then eu vejo uma mensagem de erro indicando que eu devo logar no fórum para responder à discussão
...
Scenario: Armazenar resposta à lista de discussão
  ...
  Given a discussão possui a resposta "Não faço ideia" do usuário "João"
  ...
  Then a discussão possui a minha resposta "É 2"
...
Scenario: Tentar armazenar resposta em branco à lista
  ...
  Then há uma lista de discussão "Qual é a derivada de 2x" criada pelo usuário "Carlos" armazenada no sistema
  Then a discussão possui a resposta "Não faço ideia" do usuário "João"
  Then o sistema envia uma mensagem de erro devido ao fato de uma mensagem vazia ter sido recebida

Scenario: Tentar armazenar resposta à lista trancada
  Given há uma lista de discussão "Qual é a derivada de 2x" criada pelo usuário "Carlos" armazenada no sistema
  Given a discussão possui a resposta "Não faço ideia" do usuário "João"
  Given a lista está trancada
  When eu envio a resposta "É 2" à discussão ao sistema
  Then a discussão possui a resposta "Não faço ideia" do usuário "João"
  Then o sistema envia uma mensagem de erro indicando que a discussão está trancada e não recebe novas respostas
  Then a lista continua trancada
...
Scenario: Tentar armazenar resposta sem estar logado
  ...
  When eu envio a resposta "É 2" à discussão ao sistema
  Then a discussão possui a resposta "Não faço ideia" do usuário "João"
  Then o sistema envia uma mensagem de erro indicando que eu devo logar no fórum para responder à discussão
...
Scenario: Armazenar resposta à comentário
  ...
  Then a discussão possui a resposta "Não faço ideia" do usuário "João"
  Then a discussão possui a minha resposta "É 2" armazenada como uma resposta à resposta de "João"
