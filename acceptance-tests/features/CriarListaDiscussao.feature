Feature: criar uma lista de discussão
    ...
    Scenario: criar lista de discussão
        ...
        And eu vejo que foi criada a lista de discussão de nome "Biscoitos do modo ARAM" no tópico "League of Legends"
    ...
    Scenario: criar lista de discussão com nome já existente
        ...
        And recebo um aviso de erro relacionado à duplicata de nome da lista de discussão
